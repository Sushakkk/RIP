# Generated by Django 4.2.7 on 2024-09-23 08:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('main', '0002_remove_orders_user_remove_services_category_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='self_employed_activities', to='main.activities', verbose_name='Деятельность')),
                ('self_employed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activities', to='main.selfemployed', verbose_name='Самозанятый')),
            ],
            options={
                ...
                'ordering': ('id',),
                'unique_together': {('self_employed', 'activity')},
            },
        ),
    ]
